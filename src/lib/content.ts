...
export const storePieces: StorePiece[] = [
  {
    ...
    image: "/media/relief-column-gown.png",
  },
  {
...
export const readyToCollectItems: StorePiece[] = [
  {
    slug: "tami-palazzo",
    title: "Tami Palazzo",
    collection: "Ready to Collect",
    price: "£69.99",
    size: "One size fits all",
    medium: "Ankara Dutch wax with geometric print variations",
    availability: "Ready to Collect",
    details:
      "Bold palazzo silhouette in hand-selected Ankara Dutch wax, celebrating pattern and print as design statement. Each fabric variation tells a different story.",
    image: "/media/indigo-sun-collection-mood.jpeg",
  },
  {
    slug: "cropped-box-jacket",
    title: "Cropped Box Jacket",
    collection: "Ready to Collect",
    price: "£595",
    size: "EU 36-46",
    medium: "Structured suiting wool with silk facing",
    availability: "Ready to Collect",
    details:
      "A precisely cut cropped silhouette with architectural box construction, finished with couture interior detailing. Sharp shoulders, clean lines, refined restraint.",
    image: "/media/relief-column-gown.png",
  },
  {
    slug: "pouch-surf-stitched-jumper",
    title: "Pouch Surf Stitched Jumper",
    collection: "Ready to Collect",
    price: "£245",
    size: "One size oversized",
    medium: "Organic cotton blend with hand-stitched surface detail",
    availability: "Ready to Collect",
    details:
      "Relaxed oversized silhouette featuring sculptural pouch pockets and hand-stitched surface texture that creates movement and tactile depth. Comfort meets craft.",
    image: "/media/home-triptych-fashion.svg",
  },
  {
    slug: "raised-relief-surface-design-jumper",
    title: "Raised Relief Surface Design Jumper",
    collection: "Ready to Collect",
    price: "£285",
    size: "EU 34-46",
    medium: "Merino wool with dimensional surface relief",
    availability: "Ready to Collect",
    details:
      "Dimensional surface design created through raised relief technique, turning the jumper into a textile study. Tactile, sculptural, quiet in color but bold in form.",
    image: "/media/textile-relief.svg",
  },
  {
    slug: "ink-glyph-study-i",
    title: "Ink Glyph Study I",
    collection: "Ready to Collect",
    price: "£185",
    size: "Framed",
    medium: "Black ink on premium paper",
    availability: "Ready to Collect",
    details:
      "Single sculptural glyph exploring line and form. Framed art piece that celebrates the architectural language of design.",
    image: "/media/journal-entry.svg",
  },
  {
    slug: "ink-glyph-study-ii",
    title: "Ink Glyph Study II",
    collection: "Ready to Collect",
    price: "£185",
    size: "Framed",
    medium: "Black ink on premium paper",
    availability: "Ready to Collect",
    details:
      "Layered glyphs creating rhythm and pattern. Framed art piece exploring the conversation between form and negative space.",
    image: "/media/pattern-engineering.svg",
  },
  {
    slug: "relief-textile-impression",
    title: "Relief Textile Impression",
    collection: "Ready to Collect",
    price: "£245",
    size: "Framed",
    medium: "Black ink on premium paper",
    availability: "Ready to Collect",
    details:
      "Documentation of textile surface relief, capturing the tactile language of craft. A framed study celebrating the intersection of textile and art.",
    image: "/media/atelier-detail.svg",
  },
  {
    slug: "stitch-architecture-series",
    title: "Stitch Architecture Series",
    collection: "Ready to Collect",
    price: "£325",
    size: "Large format, framed",
    medium: "Black ink and white space",
    availability: "Ready to Collect",
    details:
      "Large-format statement piece exploring seam lines and construction detail. A meditation on the architecture hidden within garment making.",
    image: "/media/couture-mastery.svg",
  },
];
